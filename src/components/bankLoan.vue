  ...
  export default {
    ...
    beforeCreate () {
      this.$nextTick(function () {
        ...
        let bankLoanId = local.getItem('bankLoanId')
        ...
        this.$http({
          method: 'get',
          timeout: 10000,
          url: `${this.$root.baseUrl}/finance/app/approve/showBankLoan.do`,
          params: {
        ...
        this.$vux.confirm.show({
          ...
          onConfirm () {
            ...
            that.$http({
              method: 'post',
              timeout: 10000,
              url: `${that.$root.baseUrl}/finance/app/approve/submitBankLoan.do`,
              params: {
                userId: userId,
                financeId: financeId,
                sign: sign,
