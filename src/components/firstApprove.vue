  ...
  export default {
    ...
    beforeCreate () {
      this.$nextTick(function () {
        ...
        let firstApproveId = local.getItem('firstApproveId')
        ...
        this.$http({
          method: 'get',
          timeout: 10000,
          url: `${this.$root.baseUrl}/finance/app/approve/showFirstApprove.do`,
          params: {
            firstApproveId: firstApproveId
          }
        }).then((res) => {
        ...
        this.$vux.confirm.show({
          ...
          onConfirm () {
            ...
            that.$http({
              method: 'post',
              timeout: 10000,
              url: `${that.$root.baseUrl}/finance/app/approve/submitFirstApprove.do`,
              params: {
                userId: userId,
                financeId: financeId,
                sign: sign,
