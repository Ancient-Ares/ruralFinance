        ...
        <div class="swiperItem" style="height: 100%">
          <div class="firstItem">
            <scroller lock-x scrollbar-y use-pullup @on-pullup-loading="loadMore" v-model="status" ref="scroller"·
              ...
              <div class="box">
                <div class="listItem" v-for="(item, index) in CreditRecordList">
                  <div class="itemBox">
                    <div class="itemImg">
                    ...
                    <div class="itemText">
                      <h4 class="itemTitle">
                        ...
                        <span class="tips">{{item.state===1?'贷款发布':(item.state===2?'审批中':(item.state===3?'已完成':(item.state===4?'未通过':'已撤销')))}}</span>
                      </h4>
            ...
            setTimeout(() => {
              ...
              this.$http({
                ...
                if (res.data.status === 'true') {
                  ...
                  this.CreditRecordList = this.CreditRecordList.concat(data)
